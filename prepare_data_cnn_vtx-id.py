...
def main(argv):
    ...
    kElastic  = 0x20;   # gamma conversion
    kInelastic  = 0x40;   # gamma conversion
    ...
    if INPUT_TYPE == "root":
        ...
        for n in fnames:
            ...
            print INPUT_DIR+'/'+n
            dir = rootFile.Get("datadump")
            keys = [rootModule+'/'+k.GetName()[:-4] for k in dir.GetListOfKeys() if '_raw' in k.GetName()]
    ...
    for entry in event_list:
        ...
        for evname in event_names:
            ...
            print 'Process event', fcount, folder, evname, 'NO.', evt_no
            ...
            print 'Found', vtx.shape[0], 'elastic/inelastic scattering'
            ...
            for v in range(vtx.shape[0]):
                ...
                if (flags & kElastic) > 0 or (flags & kInelastic) > 0:
                    ...
                    target = np.zeros(3, dtype=np.int32)     # [elastic, inelastic, not_vtx]
                    if (flags & kElastic) > 0:
                        target[0] = 1
                        cnt_elastic += 1
                    elif (flags & kInelastic) > 0:
                        target[1] = 1
                        cnt_inelastic += 1
    ...
    print 'Total size', cnt_ind, ':: elastic:', cnt_elastic, 'inelastic:', cnt_inelastic, 'empty:', cnt_void, 'on-track:', cnt_trk
